...
eventT <- surv_data %>% filter(!is.na(los) & los >= 0 & end_datetime < lubridate::ymd_hm('2018-09-01 00:00')) %>% pull(los) 
...
dates <- seq(lubridate::ymd_hm('2018-09-01 12:00', tz = "Europe/London"), lubridate::ymd_hm('2018-10-31 12:00', tz = "Europe/London"), by = '1 day')
