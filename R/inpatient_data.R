...
#'   dictionary coding system (e.g. "Waiting list", "Booked", "Accident and Emergency"...)
...
#'   dictionary coding system (e.g. "Usual Place of Residence", "NHS other Hospital Provider", "NHS run Care Home"...)
...
#'   dictionary coding system (e.g. "Own Residence", "Patient Died or Still Birth", "NHS Hospital Provider"...)
...
#'   dictionary coding system (e.g. "Ordinary Admission", "Day case admission", "Regular Day Admission"...)
...
#'   \item{provider}{The provider at which the episode took place (e.g. Lewisham and Greenwich Trust)}
#'   \item{hospital_site}{The hospital site at which the episode took place (e.g. Lewisham University Hospital)}
#'   \item{main_specialty}{The main speciality that the episode falls into coded using the NHS data (e.g. "TRAUMA & ORTHOPAEDICS", "ENT", "OPHTHALMOLOGY"...)
...
#'   \item{local_subspecialty}{Local subspeciality that the episode falls into coded using the same data dictionary coding as Main Speciality}
#'   \item{ward_category}{The type of ward that the patient is on during the episode (e.g. Acute Medical Unit)}
#'   \item{ward_stay_number}{The number of wards that the patient has been on during their stay upto this specific episode}
#'   \item{consultant}{The name or pseudo-identifier of the consultant looking after the patient}
#'   \item{diagnosis_code}{A string formed by concatenating the ICD diagnosis codes for that patient stay in the format of a single column with an identifiable separator}
#'   \item{hrg}{Healthcare Resource Group code which refers to standard groupings of clinically similar treatments which use common levels of healthcare resource which are currently used as a means of determining fair and equitable reimbursement for care services}
#'
#'
#'
#'
