...
#'   attendance (e.g. "0 yrs", "1-4 yrs", ... , "95+")}
...
#'   dictionary coding system (e.g. "First Attendance", "Planned Follow-up
#'   Attendance", "Unplanned Follow-up Attendance")
...
#'   \item{arrival_mode}{The arrival mode coded using the NHS data dictionary
#'   coding system (e.g. "Brought in by Emergency Ambulance", "Other")
...
#'   dictionary coding system (e.g. "A&E Clininc referral", "Admitted",
#'   "Discharged", ...)
...
#'   dictionary coding system (e.g. "General Medical Practitioner", "Self
...
#'   \item{start_datetime}{The datetime at which this attendance began, as a
#'   POSIXct datetime}
#'   \item{end_datetime}{The datetime at which this attendance ended, as a
#'   POSIXct datetime}
...
#'   \item{initial_assess_datetime}{The datetime at which the initial assessment
#'   was performed, as a POSIXct datetime}
#'   \item{treatment_datetime}{The datetime at which the treatment was
#'   performed, as a POSIXct datetime}
#'   \item{hrg_code}{Healthcare Resource Group code. Standard groupings of
