...
params:
  sample_weeks: 2
  timezone_config_path: "lgt-config/ed"
vignette: >
...
data_list <- hospitalflow::import_standardise_bind(import_list, tz_config_path = params$timezone_config_path)
```
...
hospitalflow::ae_attendances_admissions_age_sex(start_date = start_date, end_date = end_date,
                                                ...
                                                config_path = params$timezone_config_path)
```
