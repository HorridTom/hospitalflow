...
params:
  sample_weeks: 2
  #set all three to NA if new spell table is to be generated "~/cw-data/spell_table_cw_20190902_b7fae6f7.rds"
  existing_spell_table_path: "~/hospitalflow/data/example_spell_table_add_vars.rds"
  existing_ed_data_path: "~/hospitalflow/data/example_ed_data.rds"
  existing_ip_data_path: "~/hospitalflow/data/example_inpatient_data.rds"
vignette: >
...
if(is.na(params$existing_spell_table_path)){
...
if(is.na(params$existing_spell_table_path)){
  ...
  example_ed_data <- readRDS(params$existing_ed_data_path)
  example_inpatient_data <- readRDS(params$existing_ip_data_path)
  
  example_spell_table <- readRDS(params$existing_spell_table_path)
  
  data_start_date <- as.Date(max(min(example_spell_table$spell_start, na.rm = TRUE),
                       min(example_spell_table$spell_end, na.rm = TRUE)))
  data_end_date <- as.Date(min(max(example_spell_table$spell_start, na.rm = TRUE),
