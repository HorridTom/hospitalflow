...
if(!params$use_existing_spell_table){
  ...
  example_spell_list <- make_spell_table(ed_data = example_ed_data,
  ...
  example_spell_table <- add_spell_variables(ed_data = example_ed_data,
                                                           inpatient_data = example_inpatient_data,
                                                           spell_table = example_spell_table)
  example_moves_table <- make_moves_table(ed_data = example_ed_data,
                                                        inpatient_data = example_inpatient_data,
...
ae_attendances_admissions_age_sex(start_date = start_date, end_date = end_date,
...
plot_ed_arrival_occupancy_hour_of_day(startDate = as.POSIXct(start_date, tz = "Europe/London"),
...
four_hrs_perf_flow_groups(start_dt = as.Date(start_date),
...
ed_los_flow_grps(start_date = start_date, end_date = end_date,
                             data = example_spell_table,
                             plot_chart = TRUE,
                             hospital_name = "Anytown General Hospital")
```
...
los_att_adm_ae(start_date = start_date, end_date = end_date,
                             data = example_spell_table,
                             plot_chart = TRUE,
                             hospital_name = "Anytown General Hospital")
```
...
average_ed_los_flows(start_date = start_date, end_date = end_date,
                             data = example_spell_table,
                             plot_chart = TRUE,
                             hospital_name = "Anytown General Hospital")
```
...
plot_admissions_discharges_day_of_week(startDate = start_date, endDate = end_date,
                                    data = example_spell_table,
                                    returnPlot = TRUE,
                                    hospitalName = "Anytown General Hospital")
```
...
los_distrib_method_admission(start_date = start_date, end_date = end_date,
                                           data = example_spell_table,
                                           plot_chart = TRUE,
                                           hospital_name = "Anytown General Hospital")
```
...
occupancy_weekday_hour(start_date = as.POSIXct(start_date, tz = "Europe/London"),
...
readmissions_ip(start_date = as.POSIXct(start_date, tz = "Europe/London"),
                              end_date = as.POSIXct(end_date, tz = "Europe/London"),
                              data = example_spell_table,
                              plot_chart = TRUE,
                              hospital_name = "Anytown General Hospital",
...
plot_flow_diagram(moves_table = example_moves_table,
                                ward_level = F,
                                start = NULL,
                                end = NULL,
