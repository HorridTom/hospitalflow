...
author: "ARC/CLAHRC NWL Information Intelligence Team"
date: "`r Sys.Date()`"
...
This report was created using the _hospitalflow_ package, created by the
ARC/CLAHRC NWL Information Intelligence Team.
...
example_moves_table <- hospitalflow::make_moves_table(ed_data = example_ed_data,
                                                      ...
                                                      ward_mapping_config_path = import_list[[3]]$config_path)
```
## Example dataset
...
hospitalflow::plot_flow_diagram(moves_table = example_moves_table, 
                                ...
                                remove_static_moves = T)
```

```{r sankey-ward-level, echo=F, results='asis', fig.height=5, fig.width=7, fig.align = 'left', cache=TRUE, include = FALSE}
hospitalflow::plot_flow_diagram(moves_table = example_moves_table, 
                                ward_level = T,
                                start = NULL, 
                                end = NULL,
