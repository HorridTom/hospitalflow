...
real_test_data <- structure(list(pseudo_id = c(129L, 528L, 1191L, 1455L, 1482L, 1519L, 1659L,
                                               1730L, 1862L),
                                 gender = structure(c(2L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 1L),
                                                    .Label = c("Female", "Male"),
                                                    class = "factor"),
                                 age_band_start = c("30-34 yrs", "35-39 yrs", "50-54 yrs",
                                                    "40-44 yrs", "80-84 yrs", "0 yrs", "80-84 yrs",
                                                    "25-29 yrs", "5-9 yrs"),
                                 ethnic_category = c("Not stated","White - Any other White background",
                                 ...
                                 start_datetime = structure(c(1551481262.63053, 1551462154.29765,
                                 ...
                                 end_datetime = structure(c(1551481564.61342, 1551462465.80738,
                                                            1551471596.35501, 1551467460.53274,
                                                            1551478520.39928, 1551431533.11254,
                                                            1551405930.33802, 1551457110.66745,
                                                            1551434257.62777),
                                                          tzone = "", class = c("POSIXct", "POSIXt")),
                                 triage_category = c("Urgent", "Very Urgent", "Standard",
                                                     "Urgent", "Urgent", "Urgent", "Very Urgent",
                                                     "Standard", "Urgent"),
                                 attendance_category = c("First Attendance", "First Attendance",
                                                         "First Attendance", "First Attendance",
                                                         "First Attendance", "First Attendance",
                                                         "First Attendance", "First Attendance",
                                                         "First Attendance"),
                                 arrival_mode = c("Ambulance", "Emergency Ambulance", "Emergency Ambulance",
                                                  "Custodial Services", "Walk-in", "Emergency Ambulance",
                                                  "Emergency Ambulance", "Walk-in", "Walk-in"),
                                 attendance_disposal = c("Transferred to other Health Care Provider",
                                 ...
                                 referral_source = c("Health Care Provider", "Health Care Provider",
                                                     "Emergency Services", "Emergency Services",
                                                     "Emergency Services", "Self Referral",
                                                     "Health Care Provider", "Self Referral",
                                                     "Health Care Provider"),
                                 initial_assess_datetime = structure(c(1551481564.61342,1551462465.80738,
                                 ...
                                 treatment_datetime = structure(c(1551481564.61342, 1551462465.80738,
                                                                ...
                                                                tzone = "",
                                                                class = c("POSIXct", "POSIXt")),
                                 hrg_code = c("WD22Z", "AA15Z", "AA19Z", "AA18B", "WA24Z", "AA08A",
                                              "WA23X", "WA20Y", "WA20Y"),
                                 episode_id = c(214L, 875L, 2013L, 2488L, 2544L, 2605L, 2846L, 2972L,
                                                3178L)),
                            row.names = c(NA,-9L),
